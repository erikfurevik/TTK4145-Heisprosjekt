// Denne er vel bare for å kjøre nettverk på windows, noe som kan være ganske problematisk. Så den er vel egentlig ikke
// nødvendig for vårt prosjekt? Den er hentet far utdelt nettverksmodul
